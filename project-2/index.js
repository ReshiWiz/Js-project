let superMarket = [
  ...
  },
  {
    ...
    type: "vegetable",
    description:
      "Hazelnut in black ceramic bowl on old wooden background. forest weal th. rustic style. selective focus",
    filename: "7.jpg",
    height: 450,
    width: 301,
    price: 27.35,
  ...
  },
  {
    ...
    type: "fruit",
    description:
      "Healthy breakfast. berry crumble with fresh blueberries, raspberries , strawberries, almond, walnuts, pecans, yogurt, and mint in ceramic plates over white woo  den surface, top view",
    filename: "37.jpg",
    height: 450,
    width: 321,
    price: 21.01,
  ...
  },
  {
    ...
    type: "fruit",
    description:
      "Peaches on branch with leaves and glasses with peach juice and limon ade with ice cubes in aluminum tray over old metal table. dark rustic style. top view.",
    filename: "49.jpg",
    height: 600,
    width: 400,
    price: 25.62,
...
// let ratings_over_3 = superMarket.find(find =>  find.rating >=3)
// console.log(ratings_over_3);

//---------------------------------------------------------............//
// 2=> find the element with type 'vegetable'

// let vegetables_match = superMarket.find(veg => veg.type == 'vegetable');
// console.log(vegetables_match);
//          OR
// let types = (veg)=>{
//   return veg.type == 'vegetable'
// }
// console.log(superMarket.find(types));

//------------------------------------------------------------------------------------//

// 3=>Find the element with price < 15

// let price_Of = superMarket.find(money => money.price < 15)
// console.log(price_Of);
//       OR
// let dollar = (over)=>{
//   return over.price >20;
// }
// console.log(superMarket.find(dollar));
//------------------------------------------------------------------------------------------------------//

// 4 => Find the element with title which contains the word ‘Lemon’

// let lemon_Name = (lemon)=>{

//   lemon.title == 'lemon'
// }
// console.log(superMarket.find(lemon_Name)); // undefined

// let lemon = superMarket.find((elem)=>{
//   return  elem.title === 'lemon'
// })
...
// let elements = superMarket.find((max)=>{
//   return max.height === 450 && max.width == 450
...
// let rating_less_than_2 = superMarket.filter(less => less.rating < 2);
// console.log(rating_less_than_2); // => 11 Obj less than 2
// method -2

// let rating_less_than_two = (find)=>{
//  return find.rating < 2
// }

// console.log(superMarket.filter(rating_less_than_two)); // // => 11 Obj less than 2
...
// let total_Rating =  superMarket.reduce((acc,items)=>{
//   // console.log(`${items.rating}`);
//   return acc + items.rating;

// },0)

// console.log(total_Rating); // => 148

// method - 2

// let total_Starts = 0;
//  let ans =  superMarket.forEach((avg)=>{
//     total_Starts += avg.rating
// })

// console.log(total_Starts); // => 148
...
//  let total_Height = superMarket.reduce((acc,height)=>{
//      return acc += height.height
// },0)
// console.log(total_Height);  // => 25400

// method - 2

// let all_Height = 0;
// let avg_Height = superMarket.forEach((avgHig) => {
//   return (all_Height += avgHig.height);
// });
// console.log(all_Height); // => 25400
...
// let total_width = 0;
// for(const i of superMarket) {
//   total_width += i.width
// }
// console.log(total_width); // => 22102

//                   method - 2

//   const total_width_2 = superMarket.reduce((accWidth,total)=>{
//      return accWidth += total.width
// },0)
// console.log(total_width_2);  // => 22102

//  Mix of array methods: 

// 1 =>  Filter the elements of type: ‘dairy’ and calculate averageRatings

// let filter_dairy = superMarket.filter((dairy_type)=>{
//   return dairy_type.type == 'dairy'
// })
// console.log(filter_dairy);

// calculate averageRatings
// let sum_of_rating = superMarket.reduce((acc,val)=>{
//       return acc += val.rating
// },0)
// console.log(sum_of_rating);

//------------------------------------------------------------------------------------------------

// 2 =>  Filter the elements of type: ‘vegetable’ and calculate averagePrice

// let veg_filter = superMarket.filter((veg)=>{
//   return veg.type == 'vegetable'
// })
// console.log(veg_filter);

// calculate averagePrice :

//  let avgPrice = superMarket.reduce((acc,val)=>{
//    return acc += val.price
//  },0)
//  console.log( Math.floor(avgPrice));  // 1039

// 3 =>  Filter the elements of type: ‘fruit’ and add new property ‘isAvailable: true’

  // let type_dairy_veg = superMarket.filter(value=>{
  //    return value.type == 'dairy' && value.type == 'vegetable'
  // })

  // let new_prop = superMarket.map((pro)=>{
  //   return {
  //     ...pro,
  //     'isAvailable' : true,
  ...
  // // let type_dairy_veg = superMarket.filter(find => find.type == 'dairy' && find.type == 'vegetable')
  // console.log(type_dairy_veg);

  // let price_type = superMarket.map(pro => pro.type == 'vegetable').filter(al).length
